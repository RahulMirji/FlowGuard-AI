...
export const MenuBar = React.forwardRef<HTMLDivElement, MenuBarProps>(
  ({ className, items, activeItem, onItemClick }, ref) => {
    return (
      ...
      >
        <motion.div
          className="absolute -inset-2 bg-[radial-gradient(circle,transparent,rgba(59,130,246,0.2)_30%,rgba(168,85,247,0.2)_60%,rgba(239,68,68,0.2)_90%,transparent)] rounded-3xl z-0 pointer-events-none"
